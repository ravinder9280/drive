...
export default function HoverButton() {
    ...
    return (
        <Link href={"/dashboard"}
            className='group relative border-2 flex justify-center cursor-pointer items-center gap-3 border-white/70 rounded-full w-[10rem] h-14 
        ...
        >
            ...
            {/* Text */}
            <span className=' font-bold  tracking-wide text-sm transition-all duration-300 
                         group-hover:text-amber-50 relative z-10'>
                Get Started
            </span>

            {/* Animated dot */}
            <span className={`relative z-10 w-6 h-6 bg-amber-200 rounded-full transition-all duration-500 ease-out
